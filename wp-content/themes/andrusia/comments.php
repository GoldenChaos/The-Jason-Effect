...
<?php if ( have_comments() ) : ?>
	<h2 id="comments"><?php comments_number('Wow, it\'s quiet in here. Why not make the first comment?', 'One person had something to say:', '% people had something to say:' );?></h2>
...
<div id="respondwrapper">
<div id="respondwrapper-left"></div>
<div id="respondwrapper-right"></div>
	<div id="respond">
		<div id="minirespond"></div>
		<div id="respond-title"><?php comment_form_title( 'Leave a Comment', 'Leave a Reply to %s' ); ?></div>
